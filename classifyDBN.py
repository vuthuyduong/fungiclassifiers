...
def SavePrediction(minprobaforBlast,mincoverage,classes,classeswithsequences,testseqIDs,testseqrecords,testlabels,pred_labels,probas,outputname):
	...
	if minprobaforBlast <= 1.0:
		output.write("Index\tSequenceID\tClassification\tPrediction\tProbability\tlocal BLAST score\tlocal BLAST sim\tlocal BLAST coverage\tNumber of sequences to be compared\tBest match ID\tThreshold\tMinThreshold\n")
	else:
...
if __name__ == "__main__":
	...
	jsonfilename,jsonvariationfilename,classifiername,classificationfilename,classificationlevel,k,data_max=LoadConfig(modelname)
